...
?>
      ...
      <body>
            ...
            <div class="collapse navbar-collapse" id="navMenu">
              <ul class="navbar-nav ms-auto d-flex justify-content-between">
                ...
                <li class="nav-item dropdown ms-5">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="" data-bs-toggle="modal" data-bs-target="#change"> <i class="fa fa-lock"></i>&nbsp; &nbsp;Change Password</a></li>
        ...
        <div class="modal fade" id="payments" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Mobile Money Payment Method</h5>
                <form method="Post">
      ...
      <img src="projects/../images/img/images.png"height="150px"; width="200px"; class="ms-5">
      </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="submit" name="pay_now" class="btn btn-primary">Proceed</button>
              </div>
              </form>
            </div>
          </div>
          ...
          <div class="container check">
            <div class="row">
              ...
              <div class="col-md-5">
                  ...
                  $output .= "<table class='table my-3'>
                        ...
                        if (!empty($_SESSION['shop_cart'])) {
                          ...
                          foreach ($_SESSION['shop_cart'] as $key => $value) {
                            ...
                            <td>" . $value['pro_price'] . "Frw</td>
                            <td class='text-end'>" . number_format($value['quantity'] * $value['pro_price'], 2) . "Frw</td>
                            </tr> 
                ...
                <button type="button" name="payment" class="btn btn-primary float-end" style="width:200px;height:50px;" data-bs-toggle="modal" data-bs-target="#payments">Pay Now</button>
                </form>
              </div>
            </div>
          </div>
    ...
    if (isset($_POST['pay_now'])) {
      ...
      $p_phone = $_POST['phone'];
      $mql1 = "INSERT INTO payments(u_id,ord_id,Pay_method,phone_pay,Txr,pay_amount) VALUES('" . $_SESSION['user_id'] . "','" . $_SESSION['order_id']. "','" . $pay_method . "','" . $p_phone . "','" . $trx . "','" . $total_price . "')";
      $order = mysqli_query($db, $mql1);
...
<?php
  ...
  VALUES(
      ...
      $price
        ...
        $order = mysqli_query($db, $mql);
      }
      //save into user order
      $save = "INSERT INTO users_orders(
      ord_id,
      u_id,
      name,
      no_products,
