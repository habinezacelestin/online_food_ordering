                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">View all products</h4>
                            </div>
                                ...
                                <div class="table-responsive m-t-40">
                                    ...
                                    <thead class="thead-dark">
                                        ...
                                        <tbody>
											...
											<?php
												$sql="SELECT * FROM category,products where products.Cat_id=category.Cat_id and cat_name='Room'";
												$query=mysqli_query($db,$sql);
												
													if(!mysqli_num_rows($query) > 0 )
														{
															echo '<td colspan="7"><center>No product</center></td>';
														}
													else
														{				
																	while($rows=mysqli_fetch_array($query))
																		{
																					...
																					echo ' <tr><td>'.$rows['pro_id'].'</td>
																								<td>'.$rows['pro_name'].'</td>
																								<td>'.$rows['pro_type'].'</td>
																								<td>'.$rows['pro_description'].'</td>
                                                                                                <td>'.$rows['pro_price'].'</td>
																								<td>'.$rows['pro_image'].'</td>
															
																									 <td><a href="delete_product.php?product_del='.$rows['pro_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									 <a href="update_product.php?product_upd='.$rows['pro_id'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
																									</td></tr>';
																		}	
														}
											?>
