                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    ...
                                                    ?>
                                                    <td>
                                                        <a href="delete_orders.php?order_del=<?php echo $rows['ord_id']; ?>" onclick="return confirm('Are you sure?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-close" style="font-size:16px"></i></a>
                                                    <?php if($rows['name']==null)
                                                    { ?>
                                                    <a href="view_orders_detail.php?order_detail=<?php echo $rows['ord_id']; ?>" class="btn btn-primary btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-info" style="font-size:16px"></i></a>

                                                  
                                                <?php
                                                    }
                                                    echo '<a href="track_orders.php?order_upd=' . $rows['ord_id'] . '" " class="btn btn-success btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-check"></i></a>
																									</td>
																									</tr>';
                                                }
                                            }
